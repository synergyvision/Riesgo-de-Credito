...
#Selección de los que realizan y revisan el análisis
# SERVINAMES_CONF<- readRDS('data/Funcionarios.rds')
# PERSONAMES_CONF<- as.data.frame(readRDS('data/datausuario.rds'))

#deciles para gráficos de probabilidad
